...
export default function BookingForm(props: any) {
  ...
  if (done) return <div className="mt-5 rounded-2xl bg-green-50 p-5 text-green-800">{done === 'CONFIRMED' ? 'Booking confirmed. Your dates are reserved.' : 'Booking request created. Your host will confirm the stay and send a discount code for your next trip.'}</div>;
